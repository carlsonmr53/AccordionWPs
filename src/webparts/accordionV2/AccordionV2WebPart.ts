...
import * as strings from 'AccordionV2WebPartStrings';
...
export interface IAccordionV2WebPartProps {
  description: string;
  accordionHtml: string;
  accordionTitle: string;
}

export default class AccordionV2WebPart extends BaseClientSideWebPart<IAccordionV2WebPartProps> {
